...
CREATE TABLE `chu_de` (
  ...
  `loai_bai_viet_id` int NOT NULL,
  PRIMARY KEY (`chu_de_id`),
  KEY `FK88bu85yg6yr7xxilhorwkxofu` (`loai_bai_viet_id`),
  CONSTRAINT `FK88bu85yg6yr7xxilhorwkxofu` FOREIGN KEY (`loai_bai_viet_id`) REFERENCES `loai_bai_viet` (`loai_bai_viet_id`)
...
INSERT INTO `chu_de` VALUES (1,'Con Trỏ','Kiến thức về con trỏ',2),(2,'Lịch Nghỉ Tết','Thông báo nghỉ tết',1);
